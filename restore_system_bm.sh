...
# --- Safety Checks ---
echo "--- Bare Metal Finalization Script ---"
...
echo
echo "This script will make the system at '${RESTORE_TARGET}' bootable on '${TARGET_DISK_BM}'."
...
echo "Press Enter to open fstab in nano..."
read
nano /etc/fstab

echo "Step 2/4: Re-installing GRUB..."
grub-install ${TARGET_DISK_BM}
...
echo
echo "✅ BARE METAL FINALIZATION COMPLETE! ✅"
echo
